Dependencies: gnome-tweaks, extension manager, Tela Circle red icons (uploaded the link in reddit), Nord Theme (uploaded the link in the reddit).
...
Install The Tela-Circle-red icon pack and the Nord Theme. What I did was to just install all Tela-circle icon packs to have access to other colors as well, that's when I saw that the red one is installed, I couldnt install the red icon theme alone, so please bear that in mind.
